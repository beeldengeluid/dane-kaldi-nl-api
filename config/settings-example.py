...
MAIN_INPUT_DIR = '/mnt/dane-fs/input-files' # when running the docker container
#MAIN_INPUT_DIR = './mount/input-files' when testing locally

#asr module settings (asr.py)
ASR_OUTPUT_DIR = '/mnt/dane-fs/asr-output' # when running the docker container
#ASR_OUTPUT_DIR = './mount/asr-output' # when testing locally
